...
def main():
    ...
    train_set = NYUv2(dir='/home/lilka/NAS_AIlab_dataset/dataset/NYU2v', mode='train', trans=transforms.ToTensor(), gt_crop_size=None)
    training_data_loader = DataLoader(dataset=train_set, num_workers=opt.threads, \
        batch_size=opt.batchSize, shuffle=True)
    test_set = NYUv2(dir='/home/lilka/NAS_AIlab_dataset/dataset/NYU2v', mode='val', trans=transforms.ToTensor(), gt_crop_size=None)
